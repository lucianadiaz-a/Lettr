...
const ListingDetailsScreen = ({ navigation, route, list }) => {
    ...
    <View style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.header}>
            <View style={styles.addressContainer}>
                <Text style={styles.address}>6th Ave & 9th St</Text>
            </View>
            <View style={styles.byline}>
                <Text style={styles.neighborhood}>Greenwich Village • 3 BED : 2 BATH</Text>
            </View>
            <View style={styles.roomDate}>
                ...
                <View style={styles.dateContainer}>
                    <Text style={styles.dateText}>May 31 - August 15</Text>
                </View>
            </View>
        </View>
        <View style={styles.hostContainer}>
            <Image source={require('../../assets/images/profilepic1.png')} style={styles.hostImage} />
            <View style={styles.hostByName}>
                <Text style={styles.hostedBy}>Hosted by:</Text>
                <Text style={styles.hostName}>Jane</Text>
            </View>
        </View>
        <View style={styles.subway}>
            <Text style={styles.subwayNearby}>Subway Lines Nearby:</Text>
            <View style={styles.subwayIcons}>
                <Image source={require('../../assets/images/subway1.png')} style={styles.subwayImage}/>
            </View>
        </View>
        <AmenitiesTable amenities={listing.amenities} />
        <View style={styles.map}>
          <Image source={require('../../assets/images/map1.png')} style={styles.mapImage}/>
        </View>
      </ScrollView>
      <View style={styles.footer}>
        ...
        <View style={styles.price}>
          <Text style={styles.priceText}>$2000/month</Text>
        </View>
      </View>
      <MessageModal
